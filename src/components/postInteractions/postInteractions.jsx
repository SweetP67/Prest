    ...
    return (
        <div className="postInteractions">
            <div className="interactionIcons">  
                ...
                {data.likeCount}
                <Image path="/general/comment.svg" alt="" />
                {/* <Image path="/general/download.png" alt="" /> */}
                <Image path="/general/more.svg" alt="" />
            </div>
            <button disabled={mutation.isPending} onClick={() => mutation.mutate({id: postId, type: "save"})}>{data.isSaved ? "Đã chia sẻ" : "Chia sẻ"}</button>
        </div>
    )
}
